    ...
    <div class="col-md-4 mb-3">
        <div class="card text-white" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="card-subtitle mb-2 text-white-50">Laporan Hari Ini</h6>
                        <h2 class="card-title mb-0">{{ $laporanHariIni }}</h2>
                    </div>
...
<div class="alert alert-warning alert-dismissible fade show" role="alert" style="border-radius: 15px; border-left: 5px solid #f39c12;">
    ...
    <a href="{{ route('staff.obat.index') }}" class="alert-link">Lihat Detail</a>
    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
</div>
@endif

<div class="card" style="border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
    <div class="card-header" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: white; border-radius: 15px 15px 0 0; border: none;">
        <h5 class="mb-0"><i class="bi bi-speedometer2 me-2"></i>Ringkasan Dashboard</h5>
    </div>
    <div class="card-body">
        <p class="text-muted">Selamat datang di Dashboard Staff. Gunakan menu di sidebar untuk mengakses fitur-fitur aplikasi.</p>
    </div>
</div>
@endsection
