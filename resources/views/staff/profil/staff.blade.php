...
<div class="row">
    <div class="col-md-8 mx-auto">
        ...
        <div class="card mb-4" style="border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); border: none;">
            <div class="card-header" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: white; border-radius: 15px 15px 0 0; border: none; padding: 1.5rem;">
                <h5 class="mb-0"><i class="bi bi-person-circle me-2"></i>Informasi Profil</h5>
            </div>
            <div class="card-body" style="padding: 2rem;">
                <form action="{{ route('staff.profil.update') }}" method="POST" enctype="multipart/form-data" id="profileForm">
                    @csrf
                    @method('PUT')
        ...
        <div class="card" style="border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); border: none;">
            ...
            <div class="card-body" style="padding: 2rem;">
                <form action="{{ route('staff.profil.password') }}" method="POST">
                    @csrf
                    @method('PUT')
...
<script>
    ...
    function deletePhoto() {
        if (confirm('Yakin ingin menghapus foto profil?')) {
            fetch('{{ route("staff.profil.photo.delete") }}', {
                method: 'DELETE',
                headers: {
